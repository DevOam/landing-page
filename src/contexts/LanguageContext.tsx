...
const translations = {
  fr: {
    ...
    'privacy.dataCollected.title': '2. Données collectées',
    'privacy.dataCollected.content': 'Nous collectons plusieurs types de données personnelles pour fournir et améliorer nos services. Cela inclut des informations d\'identification telles que votre nom, adresse e-mail, numéro de téléphone et photo de profil optionnelle lorsque vous vous inscrivez pour un compte Daret. Nous collectons également des données liées à vos interactions au sein de l\'application, notamment la création et la gestion de darets, l\'historique de participation, les notifications envoyées et d\'autres métriques d\'utilisation. De plus, nous collectons des données techniques et d\'appareil telles que l\'adresse IP, le modèle d\'appareil, la version du système d\'exploitation, le fuseau horaire, les préférences linguistiques et les journaux d\'erreur/crash. Nous utilisons des données d\'analyse anonymisées pour comprendre comment les utilisateurs interagissent avec l\'application et pour améliorer l\'expérience utilisateur. Nous ne collectons ni ne traitons aucune donnée financière, transactionnelle ou bancaire.',
    'privacy.purpose.title': '3. Objectif du traitement',
