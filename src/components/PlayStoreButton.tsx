    ...
    return (
        <a href="/">
            ...
            >
                ...
                <div>
                    <div className="text-xs font-[MadaniArabic-Regular] uppercase">
                        {t('playstore.getiton')}
                    </div>
                    <div className="-mt-1 font-[MadaniArabic-SemiBold] text-xl font-semibold uppercase">
                        {t('playstore.googleplay')}
                    </div>
                </div>
            </button>
        </a>
